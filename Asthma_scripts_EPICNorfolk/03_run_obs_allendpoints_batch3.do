/*
Perform logistic regression for prevalent asthma status in measurement batch 3
*/
...
*save
save "epicn_metabolon_batch3_asthma_res.dta", replace
export delimited using "epicn_metabolon_batch3_asthma_res.txt", delimiter(tab) replace
